...
const char __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_ca_crt_ec_pem[]           = TEST_CA_CRT_EC_PEM;
const char __attribute__((section(".mbed_rodata"), noinline))mbedtls_test_ca_key_ec_pem[]           = TEST_CA_KEY_EC_PEM;
const char __attribute__((section(".mbed_rodata"), noinline))mbedtls_test_ca_pwd_ec_pem[]           = TEST_CA_PWD_EC_PEM;
const char __attribute__((section(".mbed_rodata"), noinline))mbedtls_test_ca_key_rsa_pem[]          = TEST_CA_KEY_RSA_PEM;
const char __attribute__((section(".mbed_rodata"), noinline))mbedtls_test_ca_pwd_rsa_pem[]          = TEST_CA_PWD_RSA_PEM;
const char __attribute__((section(".mbed_rodata"), noinline))mbedtls_test_ca_crt_rsa_sha1_pem[]     = TEST_CA_CRT_RSA_SHA1_PEM;
const char __attribute__((section(".mbed_rodata"), noinline))mbedtls_test_ca_crt_rsa_sha256_pem[]   = TEST_CA_CRT_RSA_SHA256_PEM;

const unsigned char __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_ca_crt_ec_der[]   = TEST_CA_CRT_EC_DER;
const unsigned char __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_ca_key_ec_der[]   = TEST_CA_KEY_EC_DER;
const unsigned char __attribute__((section(".mbed_rodata"), noinline))mbedtls_test_ca_key_rsa_der[]  = TEST_CA_KEY_RSA_DER;
const unsigned char __attribute__((section(".mbed_rodata"), noinline))mbedtls_test_ca_crt_rsa_sha1_der[]   =
    TEST_CA_CRT_RSA_SHA1_DER;
const unsigned char __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_ca_crt_rsa_sha256_der[] =
...
const char __attribute__((section(".mbed_rodata"), noinline))mbedtls_test_srv_crt_ec_pem[]           = TEST_SRV_CRT_EC_PEM;
const char __attribute__((section(".mbed_rodata"), noinline))mbedtls_test_srv_key_ec_pem[]           = TEST_SRV_KEY_EC_PEM;
const char __attribute__((section(".mbed_rodata"), noinline))mbedtls_test_srv_pwd_ec_pem[]           = "";
const char __attribute__((section(".mbed_rodata"), noinline))mbedtls_test_srv_key_rsa_pem[]          = TEST_SRV_KEY_RSA_PEM;
const char __attribute__((section(".mbed_rodata"), noinline))mbedtls_test_srv_pwd_rsa_pem[]          = "";
const char __attribute__((section(".mbed_rodata"), noinline))mbedtls_test_srv_crt_rsa_sha1_pem[]     = TEST_SRV_CRT_RSA_SHA1_PEM;
const char __attribute__((section(".mbed_rodata"), noinline))mbedtls_test_srv_crt_rsa_sha256_pem[]   = TEST_SRV_CRT_RSA_SHA256_PEM;

const unsigned char __attribute__((section(".mbed_rodata"), noinline))mbedtls_test_srv_crt_ec_der[]   = TEST_SRV_CRT_EC_DER;
const unsigned char __attribute__((section(".mbed_rodata"), noinline))mbedtls_test_srv_key_ec_der[]   = TEST_SRV_KEY_EC_DER;
const unsigned char __attribute__((section(".mbed_rodata"), noinline))mbedtls_test_srv_key_rsa_der[]  = TEST_SRV_KEY_RSA_DER;
const unsigned char __attribute__((section(".mbed_rodata"), noinline))mbedtls_test_srv_crt_rsa_sha1_der[]   =
    TEST_SRV_CRT_RSA_SHA1_DER;
const unsigned char __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_srv_crt_rsa_sha256_der[] =
...
const char __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_cli_crt_ec_pem[]   = TEST_CLI_CRT_EC_PEM;
const char __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_cli_key_ec_pem[]   = TEST_CLI_KEY_EC_PEM;
const char __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_cli_pwd_ec_pem[]   = "";
const char __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_cli_key_rsa_pem[]  = TEST_CLI_KEY_RSA_PEM;
const char __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_cli_pwd_rsa_pem[]  = "";
const char __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_cli_crt_rsa_pem[]  = TEST_CLI_CRT_RSA_PEM;

const unsigned char __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_cli_crt_ec_der[]   = TEST_CLI_CRT_EC_DER;
const unsigned char __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_cli_key_ec_der[]   = TEST_CLI_KEY_EC_DER;
const unsigned char __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_cli_key_rsa_der[]  = TEST_CLI_KEY_RSA_DER;
const unsigned char __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_cli_crt_rsa_der[]  = TEST_CLI_CRT_RSA_DER;
...
const char   __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_ca_key_rsa[]         = TEST_CA_KEY_RSA;
const char   __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_ca_pwd_rsa[]         = TEST_CA_PWD_RSA;
const char   __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_ca_crt_rsa_sha256[]  = TEST_CA_CRT_RSA_SHA256;
const char   __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_ca_crt_rsa_sha1[]    = TEST_CA_CRT_RSA_SHA1;
const char	 __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_ca_key_ec[]          = TEST_CA_KEY_EC;
const char   __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_ca_pwd_ec[]          = TEST_CA_PWD_EC;
const char   __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_ca_crt_ec[]          = TEST_CA_CRT_EC;

const char   __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_srv_key_rsa[]        = TEST_SRV_KEY_RSA;
const char   __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_srv_pwd_rsa[]        = TEST_SRV_PWD_RSA;
const char   __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_srv_crt_rsa_sha256[] = TEST_SRV_CRT_RSA_SHA256;
const char   __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_srv_crt_rsa_sha1[]   = TEST_SRV_CRT_RSA_SHA1;
const char   __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_srv_key_ec[]         = TEST_SRV_KEY_EC;
const char   __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_srv_pwd_ec[]         = TEST_SRV_PWD_EC;
const char   __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_srv_crt_ec[]         = TEST_SRV_CRT_EC;

const char   __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_cli_key_rsa[]        = TEST_CLI_KEY_RSA;
const char   __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_cli_pwd_rsa[]        = TEST_CLI_PWD_RSA;
const char   __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_cli_crt_rsa[]        = TEST_CLI_CRT_RSA;
const char   __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_cli_key_ec[]         = TEST_CLI_KEY_EC;
const char   __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_cli_pwd_ec[]         = TEST_CLI_PWD_EC;
const char   __attribute__((section(".mbed_rodata"), noinline)) mbedtls_test_cli_crt_ec[]         = TEST_CLI_CRT_EC;
...
const char * __attribute__((section(".mbed"), noinline)) mbedtls_test_ca_key = test_ca_key;
const char * __attribute__((section(".mbed"), noinline)) mbedtls_test_ca_pwd = test_ca_pwd;
const char * __attribute__((section(".mbed"), noinline)) mbedtls_test_ca_crt = test_ca_crt;

const char * __attribute__((section(".mbed"), noinline)) mbedtls_test_srv_key = test_srv_key;
const char * __attribute__((section(".mbed"), noinline)) mbedtls_test_srv_pwd = test_srv_pwd;
const char * __attribute__((section(".mbed"), noinline)) mbedtls_test_srv_crt = test_srv_crt;

const char * __attribute__((section(".mbed"), noinline)) mbedtls_test_cli_key = test_cli_key;
const char * __attribute__((section(".mbed"), noinline)) mbedtls_test_cli_pwd = test_cli_pwd;
const char * __attribute__((section(".mbed"), noinline)) mbedtls_test_cli_crt = test_cli_crt;
