...
#include <platform/stm32wb/STM32Config.h>
...
//    uintmax_t recordKey = persistedStorageKey + STM32Config::kConfigKey_GroupKeyBase;
//
//    VerifyOrExit(recordKey <= STM32Config::kConfigKey_GroupKeyMax, err = CHIP_ERROR_PERSISTED_STORAGE_VALUE_NOT_FOUND);
//
